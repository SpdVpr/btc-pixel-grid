    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex flex-col md:flex-row flex-grow">
        ...
        <div className="flex-grow md:ml-52 lg:ml-60 md:mr-52 lg:mr-60 flex flex-col">
          ...
          {/* Project information - visible only on larger screens */}
      ...
      {/* Button to open statistics - only on mobile devices, moved down */}
      <button 
        className="md:hidden fixed bottom-16 right-2 bg-gray-700 text-white p-2 rounded-full shadow-md z-20"
